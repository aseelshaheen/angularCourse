...
export class ProductListComponent {
  private static instance: ProductListComponent;
  public products: any[] = [
      ...
      details: [
        {
          key: 'Display',
          value:
            '6.7-inch Super Retina XDR display with ProMotion, HDR10, and Dolby Vision support',
        },
        {
          key: 'Camera',
          value:
            'Triple camera system with 48MP main, 12MP ultra-wide, and 12MP telephoto lenses',
        },
        {
          key: 'Processor',
          value: 'A16 Bionic chip with a 6-core CPU and 5-core GPU',
        },
        {
          key: 'Battery Life',
          value: 'All-day battery life with up to 29 hours of video playback',
        },
        {
          key: 'Design',
          value:
            'Surgical-grade stainless steel frame, Ceramic Shield front cover, and available in multiple colors',
        },
        {
          key: 'Features',
          value:
            '5G capability, Face ID, Always-On display, Dynamic Island for notifications and interactions, and iOS 16/17',
        },
      ],
    },
    {
      ...
      details: [
        ...
        { key: 'Storage', value: 'Configurations from 256GB up to 2TB SSD' },
        {
          key: 'Display',
          value:
            '13.3-inch Retina display or 14-inch and 16-inch Liquid Retina XDR displays (depending on the model)',
        },
        {
          key: 'Processor',
          value: 'Apple M2 chip with 8-core CPU and up to 10-core GPU',
        },
        {
          key: 'Battery Life',
          value: 'Up to 20 hours of video playback on a single charge',
        },
        {
          key: 'Design',
          value: 'Slim, lightweight, available in multiple colors',
        },
        {
          key: 'Features',
          value:
            'macOS Ventura, Touch ID, Magic Keyboard, Force Touch trackpad, and high-quality stereo speakers',
        },
      ],
    },
    {
      ...
      details: [
        {
          key: 'Design',
          value: 'In-ear wireless earbuds with customizable silicone tips',
        },
        {
          key: 'Sound',
          value:
        ...
        },
        {
          key: 'Battery Life',
          value:
            'Up to 4.5 hours of listening time on a single charge, with over 24 hours provided by the MagSafe charging case',
        },
        {
          key: 'Features',
          value:
            "Sweat and water resistance (IPX4), H1 chip for seamless connectivity, hands-free 'Hey Siri' functionality",
        },
        {
          key: 'Compatibility',
          value:
            'Compatible with all Apple devices running iOS, macOS, watchOS, and tvOS',
        },
      ],
    },
    {
      ...
      details: [
        {
          key: 'Design',
          value:
            'Over-ear headphones with memory foam ear cushions and stainless steel frame',
        },
        {
          key: 'Sound',
          value:
            'Active Noise Cancellation, Transparency Mode, Spatial Audio with dynamic head tracking, and Adaptive EQ',
        },
        {
          key: 'Battery Life',
          value:
        ...
        },
        {
          key: 'Features',
          value:
            'Digital crown for volume control, Siri integration, and Smart Case for ultra-low power mode',
        },
      ],
    },
    {
      ...
      details: [
        {
          key: 'Display',
          value: 'Always-On Retina display, 41mm or 45mm case size',
        },
        {
          key: 'Health Features',
          value:
            'Blood Oxygen app, ECG app, heart rate monitoring, sleep tracking, and fall detection',
        },
        { key: 'Processor', value: 'S8 SiP with 64-bit dual-core processor' },
        {
          key: 'Battery Life',
          value: 'Up to 18 hours, with fast charging capability',
        },
        {
          key: 'Connectivity',
          value:
            'GPS, Cellular models available, swim-proof, and available with different bands',
        },
        {
          key: 'Software',
          value:
            'watchOS 9, with customizable watch faces and enhanced fitness tracking',
        },
      ],
    },
    {
      ...
      details: [
        {
          key: 'Resolution',
          value: '4K HDR with Dolby Vision and HDR10+ support',
        },
        ...
        { key: 'Storage', value: '32GB or 64GB internal storage' },
        {
          key: 'Features',
          value:
            'Supports Apple Arcade, Apple Fitness+, and Apple Music. Includes Siri Remote with touch-enabled clickpad',
        },
        { key: 'Audio', value: 'Dolby Atmos support for immersive audio' },
        {
          key: 'Connectivity',
          value: 'Wi-Fi 6, Bluetooth 5.0, HDMI 2.1, and Ethernet port',
        },
        {
          key: 'Software',
          value:
            'tvOS, with access to the Apple TV app, streaming services, and HomeKit integration',
        },
      ],
    },
    ...
    // New Samsung Products
    {
      ...
      attributes: [
        {
          key: 'Colors',
          value: 'Phantom Black, Phantom Silver, Phantom Violet',
        },
      ...
      details: [
        {
          key: 'Display',
          value: '6.8-inch Dynamic AMOLED 2X with 120Hz refresh rate',
        },
        {
          key: 'Camera',
          value:
            '108MP main, 12MP ultra-wide, 10MP periscope telephoto, and 10MP telephoto lenses',
        },
        {
          key: 'Processor',
          value: 'Exynos 2200 or Snapdragon 8 Gen 2 (market-dependent)',
        },
        {
          key: 'Battery Life',
          value: '5000mAh battery with 45W fast charging',
        },
        {
          key: 'Features',
          value:
            '5G capability, IP68 water resistance, S Pen support, and One UI 5.0',
        },
      ],
    },
    {
      ...
      details: [
        ...
        { key: 'Processor', value: 'Neo Quantum Processor 4K' },
        {
          key: 'Features',
          value:
            'Object Tracking Sound+, FreeSync Premium Pro, Smart TV capabilities',
        },
        {
          key: 'Design',
          value: 'Ultra-thin bezels, Ambient Mode+, and slim design',
        },
      ],
    },
    {
      ...
      details: [
        ...
        {
          key: 'Storage',
          value: '128GB, 256GB, or 512GB with microSD expansion',
        },
        { key: 'Battery Life', value: '8000mAh with 45W fast charging' },
        {
          key: 'Features',
          value: 'S Pen included, DeX mode, and Quad AKG speakers',
        },
      ],
    },
    {
      ...
      details: [
        {
          key: 'Display',
          value: '1.4-inch Super AMOLED with Always-On Display',
        },
        { key: 'Battery Life', value: 'Up to 48 hours with wireless charging' },
        {
          key: 'Health Features',
          value: 'Blood Oxygen, ECG, heart rate monitoring, sleep tracking',
        },
        { key: 'Connectivity', value: 'Bluetooth 5.2, GPS, LTE (optional)' },
        {
          key: 'Features',
          value:
            'IP68 water resistance, Google Wear OS, and customizable watch faces',
        },
      ],
    },
    {
      ...
      details: [
        ...
        {
          key: 'Battery Life',
          value: 'Up to 20 hours with fast charging support',
        },
        {
          key: 'Features',
          value: 'Wi-Fi 6, Thunderbolt 4, Windows 11, and Slim design',
        },
      ],
    },
    {
      ...
      details: [
        ...
        { key: 'Design', value: 'Slim and portable with LED indicators' },
        {
          key: 'Features',
          value:
            'Supports pass-through charging and compatible with multiple devices',
        },
      ],
    },
  ];
  ...
  getImages(): any[] { //get images 
    return this.products.flatMap((product) => product.images);
  }

  public static getInstance(): ProductListComponent {
    if (!ProductListComponent.instance) {
      // Using a constructor for initialization
      ProductListComponent.instance = new ProductListComponent();
    }
    return ProductListComponent.instance;
  }
  constructor() {
  ...
  public getProductById(id: number): any {
    ...
    console.log('Found Product:', product);  // Log to see if the correct product is found
    return product;
  }
  ...
  public getDiscountPrice(product: any): number {
  ...
  private getStockMessage(product: any): string {
  ...
  private updateProductAttributes(): void {
    this.products.forEach((product) => {
      ...
      product.attributes = product.attributes.filter(
        (attr: any) => attr.key !== 'Discount' && attr.key !== 'In Stock'
      );
